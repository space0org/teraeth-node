...
public:
    CMainParams() {
        ...
        // For a new chain, start with zero
        ...
        consensus.upgrade11ActivationTime = 0;
        consensus.upgrade12ActivationTime = 0;
        ...
        chainTxData = ChainTxData{
            ...
            1735315200,
            // Total number of transactions (just genesis coinbase)
            1,
    ...
    CTestNetParams() {
        ...
        checkpointData = {
            /* .mapCheckpoints = */ {
                ...
                {1630783, BlockHash::fromHex("000000002e0058b88b1857bbf2ca3edaaade318e54bbb9226ca53b3ae5528f90")},
                {1636000, BlockHash::fromHex("0000000000001af6a0fb0ec4f079858b6add6d070381f94157be80fdb4809c65")},
            }};
